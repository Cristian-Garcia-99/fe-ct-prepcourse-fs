...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   objeto[metodo](); //EN ESTE CASO NO PUEDO UTILIZAR DOT
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   //return (objetomMisterioso.numeroMisterioso * 5)     //CON DOT              (AMBAS VALIDAS)
   return (objetoMisterioso["numeroMisterioso"] * 5);    //CON BRACKERT
}
